...
欢迎提供您的开源仓库 —— 你的作品会列在上表，成为后来者动手时的起点：

用 Clover 引擎做一款游戏，大小均可（从 [新手指南](ai-quick-start.md) 开始）

任何方式都行：到 [clover-doc](https://github.com/qw576483/clover-doc) 提 issue，或者联系作者，或者提 PR 照上表加一行。
